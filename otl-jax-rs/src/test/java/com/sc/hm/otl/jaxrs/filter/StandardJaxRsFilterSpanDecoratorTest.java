 ...
 */
public class StandardJaxRsFilterSpanDecoratorTest extends AbstractFilterTest {
    ...
    public void testOnRequest() {
        ...
        try (Scope scope = tracer.activateSpan(span)) {
            JaxRsFilterSpanDecorator decorator = new StandardJaxRsFilterSpanDecorator();
            ...
            assertEquals(4, tags.size()
                , "Total number of tags set by JaxRsFIlterSpanDecorator.onRequest() must be 4");
    ...
    public void testOnResponse() {
        ...
        try (Scope scope = tracer.activateSpan(span)) {
            ...
            assertEquals(1, tags.size()
                , "Total number of tags set by JaxRsFIlterSpanDecorator.onResponse() must be 1");
