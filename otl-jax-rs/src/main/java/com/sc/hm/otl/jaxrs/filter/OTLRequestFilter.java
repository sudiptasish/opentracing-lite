 ...
 * is recommended to add the {@link OTLRequestFilter} in the <code>web.xml</code>.
 * 
 * <p>
 ...
 */
@Provider
public class OTLRequestFilter implements ContainerRequestFilter {
    
    private final Logger logger = LoggerFactory.getLogger(OTLRequestFilter.class);
    ...
    public void filter(ContainerRequestContext requestCtx) throws IOException {
        ...
        SpanContext context = tracer.extract(Format.Builtin.TEXT_MAP_EXTRACT
            , new ContainerRequestAdapter(requestCtx));
     ...
     * @return JaxRsFilterSpanDecorator
     */
    private JaxRsFilterSpanDecorator initDecorator(String decoratorClass) {
