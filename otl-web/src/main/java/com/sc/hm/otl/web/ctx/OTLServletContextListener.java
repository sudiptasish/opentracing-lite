...
/**
 * <p>
 * An alternate way to initialize the {@link OTLFilter}.
 * 
 ...
 * 
 * Our aim is to initialize and register the {@link OTLFilter} with the container.
 ...
 * 
 * If you do not want to specify the {@link OTLFilter} in the web.xml, then an
 ...
 * register the {@link OTLFilter} with default configuration. In default mode, the
 ...
 * </pre>
 *
 * You must also ensure to provide the url mapping for the {@link OTLFilter}, as shown below:
 * 
 * <pre>
 * {@code 
 * <web-app>
 ...
 */
@WebListener
public class OTLServletContextListener implements ServletContextListener {
    
    private final Logger logger = LoggerFactory.getLogger(OTLServletContextListener.class);
