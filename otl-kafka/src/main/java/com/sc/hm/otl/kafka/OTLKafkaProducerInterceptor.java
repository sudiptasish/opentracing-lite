 ...
 */
public class OTLKafkaProducerInterceptor implements ProducerInterceptor<Object, Object> {

    private final Logger logger = LoggerFactory.getLogger(OTLKafkaProducerInterceptor.class);
    
    private final Tracer tracer = GlobalTracer.get();
    
    private final List<KafkaSpanDecorator> decorators = new ArrayList<>();
    
    public OTLKafkaProducerInterceptor() {
