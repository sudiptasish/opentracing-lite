 ...
 */
public class OTLKafkaConsumerInterceptor<K, V> implements ConsumerInterceptor<K, V> {
    
    private final Logger logger = LoggerFactory.getLogger(OTLKafkaConsumerInterceptor.class);
    
    private final Tracer tracer = GlobalTracer.get();
    
    private final List<KafkaSpanDecorator> decorators = new ArrayList<>();

    public OTLKafkaConsumerInterceptor() {
