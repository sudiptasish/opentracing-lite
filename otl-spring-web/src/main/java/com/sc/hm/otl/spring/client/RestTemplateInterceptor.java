...
public class RestTemplateInterceptor implements ClientHttpRequestInterceptor {
    ...
    private final List<RestTemplateSpanDecorator> decorators =
        Arrays.asList(new StandardRestTemplateSpanDecorator());
    ...
    public ClientHttpResponse intercept(HttpRequest request
        ...
        if (enableSpan) {
            ...
            tracer.inject(span.context()
                ...
                , new RestTemplateHeaderCarrier(request.getHeaders()));

            for (RestTemplateSpanDecorator decorator : decorators) {
